...
void ed::Municipio::leerMunicipio()
{
  ...
  std::cout <<BIYELLOW<< "\n Lectura de los datos de un municipio" <<RESET<< std::endl;

  std::cout <<BIBLUE<< " Nombre --> ";
  // Uso de getline para leer nombres compuestos separados por espacios
  std::getline(std::cin,cadena);
  this->setNombre(cadena);
  std::cout <<RESET;

  std::cout <<BIBLUE<< " Código postal --> ";
  std::cin >> n;
  ...
  std::cout <<BIBLUE<< " Número total de hombres --> ";
  std::cin >> n;
  // Se elimna el salto de línea
  std::cin.ignore();
  // 
  ...
  std::cout <<BIBLUE<< " Número total de mujeres --> ";
  std::cin >> n;
  // Se elimna el salto de línea
  std::cin.ignore();
  // 
...
*/
  std::cout<<BIBLUE<<"Codigo Postal: "<<this->getCodigoPostal()<<RESET<<std::endl; 
  std::cout<<BIBLUE<<"Nombre: "<<this->getNombre()<<RESET<<std::endl;
  std::cout<<BIBLUE<<"Hombres: "<<this->getHombres()<<RESET<<std::endl;
  std::cout<<BIBLUE<<"Mujeres: "<<this->getMujeres()<<RESET<<std::endl;
  std::cout<<BIBLUE<<"Habitantes: "<<this->getHabitantes()<<RESET<<std::endl;
